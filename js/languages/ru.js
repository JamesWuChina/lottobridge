...
const ru = {
    ...
    footer: {
        company: {
            name: "LottoBridge",
            description: "Ведущий мировой поставщик технологических решений для лотерей, стремящийся предоставлять инновационные и надежные решения для клиентов."
        },
        products: {
            ...
            digital: "Цифровая лотерейная система",
            instant: "Система мгновенных билетов",
            sports: "Система спортивных ставок",
            video: "Система видеолотереи",
            terminals: "Лотерейные терминалы"
        },
        resources: {
        ...
        contact: {
            ...
            address: "Блок Б, Промышленный парк Хунсян, Район Тунчжоу, Пекин",
            wechat: "Сканируйте, чтобы следить в WeChat"
        },
        copyright: {
    ...
    case_studies: {
        ...
        kenya: {
            title: "Построение мобильной лотерейной платформы Кении",
            ...
            feature1: "Консультации по категориям лотерей + дизайн защищенных билетов + печать мгновенных билетов",
            feature2: "Предоставлено 10 типов индивидуальных билетов, все прошли проверку местного правительства",
            testimonial: "Мобильное решение LottoBridge позволило нам достичь скачкообразного роста на кенийском рынке!",
            country: "Кения",
            country_name: "Кения",
            client: "Генеральный директор частного лотерейного оператора Кении",
            client_type: "Тип клиента:",
            client_type_value: "Частный оператор",
            period: "Период проекта:",
            period_value: "2021-2023",
            result: "Основные результаты:",
            result_value: "Рост пользователей 120%, доля рынка поднялась в топ-2",
            scope_value: "Разработка мобильного приложения, интеграция платежей, развертывание терминалов, продвижение на рынке",
            page_title: "Построение мобильной лотерейной платформы Кении | LottoBridge",
            slogan: "Мобильный приоритет, инновации движут новую экосистему африканских лотерей",
            delivery_title: "Содержание поставки и процесс обслуживания",
            highlight1: {
                title: "Дизайн с мобильным приоритетом",
                desc: "Полный мобильный опыт, совместимый с основными смартфонами, удобная покупка лотерейных билетов"
            },
            highlight2: {
                title: "Инновация интеграции платежей",
                desc: "Глубокая интеграция с мобильным платежом M-Pesa, улучшение коэффициента конверсии пользователей"
            },
            highlight3: {
                title: "Значительный рост пользователей",
                desc: "Рост пользователей 120%, доля рынка поднялась в топ-2"
            },
            highlight4: {
                title: "Успешное продвижение на рынке",
                desc: "Многоканальное продвижение на рынке, влияние бренда значительно улучшено"
            },
            delivery1: {
                title: "Исследование рынка",
                desc: "Глубокий анализ кенийского лотерейного рынка и потребностей пользователей"
            },
            delivery2: {
                title: "Разработка мобильного приложения",
                desc: "Индивидуальная разработка лотерейного приложения, адаптированного для местных условий"
            },
            delivery3: {
                title: "Интеграция платежей",
                desc: "Глубокая интеграция с мобильным платежом M-Pesa"
            },
            delivery4: {
                title: "Продвижение на рынке",
                desc: "Многоканальное продвижение на рынке, улучшение влияния бренда"
            },
            highlight1: {
